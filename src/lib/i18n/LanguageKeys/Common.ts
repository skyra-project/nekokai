...
export const FormatList = FT<{ value: unknown[] }, string>('commands/common:formatList');
export const FormatNumber = FT<{ value: number }, string>('commands/common:formatNumber');
